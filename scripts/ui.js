...
export default class UI {
  ...
  renderLoader() {
    this.list.innerHTML = `<div class="container"><div class="loader"></div></div>`;
  }
  //ekrana kartları bas
  renderCards(songs) {
    ...
    //dizideki her bir eleman için aşağıdaki fonk. çalıştır
    songs.forEach((song) => {
      //1 elementi oluştur
      ...
      div.dataset.url = song.hub?.actions[1].uri; //oynatma linki yoksa ? hata vermesin
  ...
  //müziği oynatma kısmını ekrana bas
